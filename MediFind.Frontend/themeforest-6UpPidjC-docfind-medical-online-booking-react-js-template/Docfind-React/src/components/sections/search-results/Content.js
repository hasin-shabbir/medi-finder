...
class Content extends Component {
  ...
  render() {
    const paginationData = this.props.drugs
      ...
      .map((item, i) => {
        return (
          <div className="sigma_team style-17" key={i}>
            <div className="row no-gutters">
              ...
              <div className="col-md-5 col-sm-6">
                <div className="sigma_team-body">
                  <h5>
                    <Link to={"/drug-details/" + item.drugId}>
                      {item.drugName}
                    </Link>
                  </h5>
                  ...
                  <div className="d-flex align-items-center mt-4">
                    ...
                    <div className="sigma_team-controls ml-3">
                      <Link
                        to="#"
                        className={this.state.favorite === item ? "active" : ""}
                        onClick={(e) => this.favoriteTrigger(item)}
                      >
